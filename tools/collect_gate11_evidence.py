...
def main()->int:
 ...
 version_ok=spine.get('version')=='0.11.0-gate11-commercial-evidence-local' and version is not None and '0.11.0-gate11-commercial-evidence-local' in version
