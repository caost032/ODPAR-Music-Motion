...
def main()->int:
    ...
    exp={'modules':44,'dependencies':144,'invariants':63,'capabilities':53,'state_models':11,'security_investigations':41};spine_ok=all(spine.get(k,0)>=v for k,v in exp.items())
