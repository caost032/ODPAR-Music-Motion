...
def main()->int:
    ...
    exp={'modules':42,'dependencies':134,'invariants':58,'capabilities':47,'security_investigations':36};spine_ok=all(spine.get(k,0)>=v for k,v in exp.items())
